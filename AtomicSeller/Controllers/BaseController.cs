...
namespace AtomicSeller.Controllers
{
    public partial class User
    {
        ...
        public Nullable<System.DateTime> PwResetTokenValidity { get; set; }
    ...
    public partial class Tenant
    {
        ...
        public Nullable<int> AtomicClientID { get; set; }
        public string AtomicClientKey { get; set; }
        public Nullable<int> TenantType { get; set; }
    ...
    public class BaseController : Controller
    {
        ...
        public bool setSessionBagInitData(User user = null, Tenant tenant = null)
        {
            ...
            try
            {
                Tools.ErrorHandler(tenant.CompanyName + "/" + user.UserName + " connects as profile " + user.UserProfileID + " to : " + ConnectionString, null, false, true, false);
            }
            catch
            {
